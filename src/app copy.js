...
const main = async () => {
    ...
    const [rows] = await connection.execute(`
        ...
        FROM
            whatsapp_bots wb
        JOIN
            whatsapp_phone_numbers wpn ON wb.whatsapp_bot_id = wpn.whatsapp_bot_id
        JOIN
            whatsapp_business_accounts wba ON wpn.whatsapp_business_accounts_id = wba.whatsapp_business_id
    `);

    const botsConfig = rows.map(row => ({
        flows: [dxFlow, welcomeFlow, registerFlow, fullSamplesFlow],
        jwtToken: row.api_token,
        numberId: row.phone_number_id,
    ...
    console.log('botsConfig', botsConfig);
