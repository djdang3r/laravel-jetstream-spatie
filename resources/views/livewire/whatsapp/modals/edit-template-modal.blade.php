        ...
        <div class="modal-content bg-default">
            ...
            <form id="editTemplateForm">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="editTemplateVariable">Variable de la plantilla</label>
                    ...
                    <div class="form-group mb-3" id="headerTextGroup">
                        ...
                        <input type="text" id="editHeaderText" name="editHeaderText" class="form-control"
                            maxlength="60">
                    ...
                    <!-- Header Image -->
                    <div class="form-group mb-3" id="headerImageGroup">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea id="editBodyText" name="editBodyText" class="form-control" rows="4" maxlength="1024" required></textarea>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="editFooterText" name="editFooterText" class="form-control"
                            maxlength="60">
